/*
===============================================================================
Script Name: APPPLM-3672-JW_Update_T_EWO_DAT_SCR_Flag.sql
===============================================================================
...
V1.0.2    06-10-2025  Jesco Wurm    Renamed Script & changed output to English
===============================================================================
  */
SET SERVEROUTPUT ON;
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('Total number of updated rows: ' || updated_count);
END;
/