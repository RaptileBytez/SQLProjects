...
===============================================================================
*/
CREATE OR REPLACE EDITIONABLE VIEW "V_PLM_DPH_BOM" (
  "BOM_CID",
  "ECO_NUMBER",
  "PARENT_ITEM_NUMBER",
  ...
  "CPP_CRIT",
  "CPP_RQ",
  "CPP_USAGE") DEFAULT COLLATION "USING_NLS_COMP"
AS
SELECT
    ECO_BOM.BOM_CID,
    ECO_BOM.ECO_NUMBER,
    ...
    STR.CPP_RQ,
    STR.CPP_USAGE
FROM T_ERP_ECO_BOM ECO_BOM
INNER JOIN T_MASTER_STR STR
    ON STR.C_ID = ECO_BOM.BOM_CID;